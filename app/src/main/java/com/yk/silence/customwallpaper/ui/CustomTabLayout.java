package com.yk.silence.customwallpaper.ui;
...
public class CustomTabLayout extends HorizontalScrollView {
     ...
     * <li>Set our {@link CustomTabLayout.OnTabSelectedListener} which will forward
     ...
     */
    public CustomTabLayout setupWithViewPager(@NonNull ViewPager viewPager) {
     ...
     */
    public CustomTabLayout setTabsFromPagerAdapter(@NonNull PagerAdapter adapter) {
        removeAllTabs();
    ...
    public static final class Tab {
        ...
        private final CustomTabLayout mParent;
    ...
    public CustomTabLayout addTabs(String... tabs) {
    ...
    public CustomTabLayout setTabMargin(int margin) {
    ...
    public CustomTabLayout setBottomLineColor(int lineColor) {
    ...
    public CustomTabLayout setOnMaterialTabSelectedListener(MaterialTabSelectedListener listener1) {
